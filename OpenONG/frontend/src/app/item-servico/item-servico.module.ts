...
import { ItemServicoComponent } from './item-servico.component';
import { ListComponent } from './list/list.component';
const appRoutes: Routes = [
    { path: '', component: ItemServicoComponent },
...
@NgModule({
    ...
    exports: [],
    declarations: [ItemServicoComponent, ListComponent]
})
export class ItemServicoModule { }
